...
<div class="page-header">
  <div class="page-title">
    <h3>Edit User Group<small><?php echo $this->config->item('website_name');?> user group</small></h3>
  </div>
</div>
<!-- /page header -->
...
<div class="post_contents">
  <?php $attributes = array('class' => 'validate form-horizontal', 'id' => 'editUserGroup'); echo form_open($this->uri->uri_string(), $attributes) ?>
  <div class="block">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <?php 
			...
			echo form_dropdown('status', $userstatus, $group_status ,$status_atts); 
			?>
      </div>
    </div>
    <div class="form-group">
        ...
        <div class="permission_group">
           ...
           <div class="permission_group">
                ...
                <?php } ?>
                 ...
                 <?php if($this->ci_auth->canDo('impersonate_users')) { ?>
                <div class="permission_group">
                <label class="checkbox-inline checkbox-info">
                <div class="checker">
                <?php echo form_checkbox($impersonate_users); ?>
                  </div>Impersonate as Users</label>
                </div>
                <?php } ?>
    ...
    <div class="form-actions text-right"> <?php echo form_hidden('group_id', $group_id);?>
