  ...
  <div class="col-md-12">
    <div class="panel"> 
      <div class="panel-header bg-green">
        <h3>Add Backlink page</h3>
      </div>
      
      <div class="panel-content">
        <form class="validate" id="addlinkpage" action="<?php echo site_url(); ?>addlinkpage" method="post" onsubmit="return validate();">
          <div class="row">
             ...
             <div class="col-md-8 col-xs-12 col-sm-12">
              <div class="form-group">
                ...
                <select class="form-control"   data-search="true" name="backlink_domain_id" id="backlink_domain_id">
                    <option selected="selected" value="">Choose a client</option>
                </select>
            ...
            <div class="col-md-2 col-xs-12 col-sm-12" style="margin-top:30px;">
             ...
             <div class="col-md-12 col-xs-12 col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="link" id="link" class="form-control" placeholder="link page url">
              </div>
            </div>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
              <div class="form-group">
                <label>Date:</label>
                <input type="text" name="date" id="date" class="form-control" placeholder="YYYY-MM-DD" data-date-format="yyyy-mm-dd">
              </div>
            </div>
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              <div class="form-group">
                <button name="button" type="Submit" class="btn btn-warning" id="button" value="true" style="margin-top:25px;">Add Backlink</button>
              </div>
            </div>
          </div>
        <?php echo form_close(); ?>
