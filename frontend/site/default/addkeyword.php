      ...
      <div class="row">
       <!-- <div class="left_sidebar pull-left col-md-2">
        ...
        <div class="main_content pull-left col-md-6">
          ...
          <h3 class="profiletitle"><span class="profile_title">Add Keyword - ( <?php echo $websitename; ?>)</span></h3>  
	  
          <?php $attributes = array('class' => 'validate', 'id' => 'addKeyword'); echo form_open( site_url('serp/addproject/insertkeyword'), $attributes) ?>
