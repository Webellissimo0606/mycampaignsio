...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('frontend/site/default/new-ui/assets/css/body.min.css'); ?>" />
	<link rel="stylesheet" href="<?php echo base_url('frontend/site/default/new-ui/assets/css/forms.min.css'); ?>" />
	<link rel="stylesheet" href="<?php echo base_url('frontend/site/default/new-ui/assets/css/general.min.css'); ?>" />
	<link rel="stylesheet" href="<?php echo base_url('frontend/site/default/new-ui/assets/css/sidebar.min.css'); ?>" />
	<link rel="stylesheet" href="<?php echo base_url('frontend/site/default/new-ui/assets/css/main-section-layout.min.css'); ?>" />
