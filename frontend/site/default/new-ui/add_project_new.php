                        ...
                        <div class="edit-site-form-inner active-1">
                            ...
                            <div class="edit-site-form-section ph3 cf">
                                ...
                                <div class="fl pa2 pt2-l pr3-l pl2-l w-100 w-50-l">
                                    ...
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            ...
                                            <?php checkbox_component('monitor_website_uptime', 1 === 0 ); ?>
                                        </div>
                                    </div>
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            <span>Is your site ecommerce site ?</span>
                                            <?php checkbox_component('is_ecommerce', 1 === 0 ); ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="fl pa2 pt2-l pr2-l pl3-l w-100 w-50-l">
                                    <div class="field">
                                        ...
                                        <input type="text" placeholder="Page Header to Search" name="page_header" value="">
                                    </div>

                                    <div class="field">
                                        <label for="page_body">Page Body</label>
                                        <input type="text" placeholder="Page Body to Search" name="page_body" value="">
                                    </div>

                                    <div class="field">
                                        <label for="page_footer">Page Footer</label>
                                        <input type="text" placeholder="Page Footer to Search" name="page_footer" value="">
                                    </div>
                                        ...
                                        <select multiple="multiple" name="subusers" placeholder="Choose subusers" class="multi-select-box"> <?php 
                                            if( is_array($subusers) && ! empty($subusers) ){
                                                foreach($subusers as $subuser){ ?>
                                                    <option value="<?php echo $subuser['id']; ?>"><?php echo $subuser['first_name'] . ' ' . $subuser['last_name']; ?></option> <?php
                                                }
                                            } ?>
                                        </select>
                                    </div>
                                        ...
                                        <select multiple="multiple" name="groups" placeholder="Choose groups" class="multi-select-box"> <?php 
                                            if( is_array($groups) && ! empty($groups) ){
                                                foreach($groups as $group){ ?>
                                                    <option value="<?php echo $group['id']; ?>"><?php echo $group['group_name']; ?></option><?php 
                                                }
                                            } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="edit-site-form-section active ph3 cf">
                                ...
                                <div class="fl pa2 pt2-l pr3-l pl2-l w-100 w-50-l">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" placeholder="http://" name="adminURL" value="">
                                    </div>

                                    <div class="field">
                                        <label for="adminUsername">Admin Username</label>
                                        <input type="text" placeholder="Admin Username" name="adminUsername" value="">
                                    </div>
                                    ...
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            <div class="checkbox-wrap">
                                                ...
                                                <?php checkbox_component('connect_to_google', 1 === 0 ); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            <div class="checkbox-wrap">
                                                ...
                                                <?php checkbox_component('monitor_malware', 1 === 0 ); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            <div class="checkbox-wrap">
                                                ...
                                                <?php checkbox_component('crawl_error_webmaster', 1 === 0 ); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            ...
                                            <?php checkbox_component('search_query_webmaster', 1 === 0 ); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="edit-site-form-section ph3 cf">
                                ...
                                <div class="fl pa2 pt2-l pr3-l pl2-l w-100 w-50-l">
                                            ...
                                            if( is_array($search_engines) && ! empty($search_engines) ){ ?>
                                                <optgroup label="Search engine"> <?php
                                                    foreach($search_engines as $se){ ?>
                                                        <option value="<?php echo $se['val']; ?>"><?php echo $se['title']; ?></option> <?php
                                                    } ?>
                                                </optgroup> <?php
                                            } ?>
                                        </select>
                                    ...
                                    <div class="field">
                                        <textarea name="keywords" class="form-control" rows="26" placeholder="Enter your keywords, one per line, that you would like to monitor"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="fl pa2 pt2-l pr2-l pl3-l w-100 w-50-l">
                                    <div class="field">
                                        <div class="checkbox-wrap">
                                            ...
                                            <?php checkbox_component('include_mobile_search', 1 === 0); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
