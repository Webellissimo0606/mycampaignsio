...
$body_bottom_scripts = array(
	...
	array("type" => "text/javascript", "src" => base_url('frontend/site/default/js/jquery-3.2.1.min.js') ),
	array("type" => "text/javascript", "src" => base_url('frontend/site/default/js/jquery-migrate-1.4.1.min.js') ),
	array("type" => "text/javascript", "src" => base_url('frontend/site/default/js/Vanilla-DataTables/dist/vanilla-dataTables.min.js') ),
	array("type" => "text/javascript", "src" => base_url('frontend/site/default/js/Choices/assets/scripts/dist/choices.min.js') ),
