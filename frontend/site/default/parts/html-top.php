...
$stylesheets = array(
    ...
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/tachyons.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/body.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/forms.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/general.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/sidebar.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/main-section-layout.min.css' ) ),
    array( "rel" => "stylesheet", "href" => base_url( 'frontend/site/default/css/styles.min.css' ) ),
);
