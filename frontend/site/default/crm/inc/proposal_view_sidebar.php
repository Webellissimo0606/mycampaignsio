<aside class="page-aside" style="background: none repeat scroll 0 0 rgba(253, 253, 253, 0); width: 24%; height: 100%; position: fixed; right: 0px; padding-bottom: 61px; z-index: 999; border-radius: 0px; overflow: scroll; overflow-x: hidden; background: rgb(255, 255, 255); /* border-left: 3px solid rgb(238, 238, 238); */ box-shadow: -20px 0px 20px 3px rgba(0, 0, 0, 0.06);">
		...
		<div class="panel-default panel-table borderten lead-manager-head" style="overflow: scroll;">
			<div class="panel-heading">
				<div id="details" class="clearfix" style="font-size: 12px;">
					...
					<div id="client">
						<div class="proposalto">
							<b><?php echo lang('proposalto'); ?>:</b>
						</div>
						<h2 class="toname">
				...
				<div class="btn-group col-md-12 md-pr-0 md-pl-0 md-pb-10">
					<button data-proposalid="<?php echo $proposals['id']; ?>" class="btn accept-proposal btn-default btn-big col-md-4"><i class="icon ion-checkmark-round"></i> <?php echo lang('accept')?> </button>
					<button data-proposalid="<?php echo $proposals['id']; ?>" class="btn decline-proposal btn-default btn-big col-md-4"><i class="icon ion-close-round"></i> <?php echo lang('decline')?> </button>
					<a target="_blank" href="<?php echo base_url('share/pdf_proposal/'.$proposals['id'].''); ?>" class="btn btn-default btn-big col-md-4"><i class="icon ion-document"></i> <?php echo lang('pdf')?> </a>
				</div>
				<?php foreach($comments as $comment){?>
				<div class="comment-block">
			  	<img class="comment-image" src="<?php echo base_url('assets/img/customer_avatar_comment.png') ?>"/>
				...
				<button type="submit" class="btn btn-lg btn-default col-md-12">
					<?php echo lang('addcomment');?>
				</button>
				<?php echo form_close(); ?>
				</div>
			</div>
