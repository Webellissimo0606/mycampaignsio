		...
		<div class="invoice">
			...
			<div class="row invoice-data">
				<div class="col-xs-5 invoice-person">
					...
					<span>
						<?php echo $settings['postcode'] ?>/
						<?php echo $settings['town'] ?>/
						<?php echo $settings['city'] ?>,
						<?php echo $settings['countryid'] ?>
					</span>
				...
				<div class="col-xs-5 invoice-person">
					<span class="name">
						<?php if($invoices['customer']===NULL){echo $invoices['namesurname'];} else echo $invoices['customer']; ?>
					</span>
					<span>
						<?php echo $invoices['companyemail']; ?>
					</span>
					<span>
						<?php echo $invoices['customeraddress']; ?>
					</span>
					<span>
						<?php echo $invoices['companyphone'] ?>
					</span>
					<span>
