...
<div class="page-container edit_profile_page">
  <!-- Content -->
  <div class="page-container">      <!-- Content -->      <div class="page-content">          <div class="page-content-inner">              <div class="panel_top">                  <div class="container">
      <!-- Page header -->
      ...
      <div class="row">
       <!-- <div class="left_sidebar pull-left col-md-2">
        ...
        <div class="main_content pull-left col-md-6">
          ...
          <?php $attributes = array('class' => 'validate', 'id' => 'addProject'); echo form_open($this->uri->uri_string().'/insertproject', $attributes) ?>
          <div class="user_profile row">
            ...
            <div class="edit_profile_fields">
              <div class="col-md-11">
                ...
                <?php echo form_textarea($keywords); ?></div>
            </div>
			<div class="edit_profile_fields">
              <div class="col-md-11">
