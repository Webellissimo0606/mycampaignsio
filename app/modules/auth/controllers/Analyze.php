...
//                        "reportId" => '56925f490cf24b6379fb3613'
    ...
    function getkeywordreport() {
        ...
        elseif( $this->ci_auth->is_logged_in(false) ){
            ...
            $data = array(
                'avg_position' => $this->analyze_model->getAveragePosition($user_id, $domain_id),
                'keyword_changes' => $this->analyze_model->getKeywordChangeFromWeeks($user_id, $domain_id),
                'position' => $this->analyze_model->getKeywordPositionStats($user_id, $domain_id),
                'total_keywords' => $this->analyze_model->getTotalKeywords($user_id, $domain_id)
            );
