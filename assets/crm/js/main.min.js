...
var App = function () {
		...
		function b() {
			...
			b.on("click", function (b) {
				var c, d = $(this),
					e = i.leftSidebarSlideSpeed,
					f = d.parent(),
					g = d.next();
				c = f.siblings(".open"), c && c.find("> ul:visible").slideUp({
					duration: e,
					complete: function () {
						c.toggleClass("open"), $(this).removeAttr("style"), a()
					}
				}), f.hasClass("open") ? g.slideUp({
					duration: e,
					complete: function () {
						f.toggleClass("open"), $(this).removeAttr("style"), a()
					}
				}) : g.slideDown({
					duration: e,
					complete: function () {
			...
			}), $("li.active", m).parents(".parent").addClass("active open"), l.hasClass("be-fixed-sidebar") && (c.perfectScrollbar(), $(window).resize(function () {
				p(function () {
...
FastClick.prototype.needsClick = function (a) {
	...
	function c(b, c) {
		...
		function K(b, d, k) {
			...
			}, this), c.doubleTapThreshold)) : (_a = null, Ta.trigger("tap", [b.target]), c.tap && (l = c.tap.call(Ta, b, b.target)))) : k == p ? d !== y && d !== x || (clearTimeout(ab), clearTimeout(bb), _a = null, Ta.trigger("doubletap", [b.target]), c.doubleTap && (l = c.doubleTap.call(Ta, b, b.target))) : k == q && (d !== y && d !== x || (clearTimeout(ab),
				_a = null, Ta.trigger("longtap", [b.target]), c.longTap && (l = c.longTap.call(Ta, b, b.target)))), l
		}
