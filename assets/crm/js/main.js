var App = (function () {
	...
	var colors = {};
	var body = $("body");
	var wrapper = $(".ciuis-body-wrapper");
	var leftSidebar = $(".ciuis-body-left-sidebar");
	var rightSidebar = $(".ciuis-body-right-sidebar");
	...
	function leftSidebarInit() {
		...
		function updateScroller() {
			if (wrapper.hasClass("ciuis-body-fixed-sidebar")) {
		...
		firstAnchor.on("click", function (e) {
			...
			var $el = $(this),
				$open, $speed = config.leftSidebarSlideSpeed;
			var $li = $el.parent();
			var $subMenu = $el.next();
	...
	function rightSidebarInit() {
		...
		var rsScrollbar = $(".ciuis-body-scroller", rightSidebar);
		...
		if (rightSidebar.length > 0) {
			...
			$('.ciuis-body-toggle-right-sidebar').on("click", function (e) {
		...
		$('a[data-toggle="tab"]', rightSidebar).on('shown.bs.tab', function (e) {
			var scrollEl = $(e.target.getAttribute("href")).find('.ciuis-body-scroller');
			if (scrollEl.length) {
	...
	function chatWidget() {
		var chat = $(".ciuis-body-right-sidebar .tab-chat");
		...
		var messagesScroll = $(".ciuis-body-scroller", messagesContainer);
	...
	function scrollerInit() {
		$(".ciuis-body-scroller").perfectScrollbar();
	}

	function scrollTopButton() {
		var offset = 220;
		var duration = 500;
		var button = $('<div class="ciuis-body-scroll-top"></div>');
	...
	return {
		...
		init: function (options) {
			...
			$(".ciuis-body-connections").on("click", function (e) {
				e.stopPropagation();
			});
			...
			$('.dropdown').on('shown.bs.dropdown', function () {
				$(".ciuis-body-scroller").perfectScrollbar('update');
			});
			...
			$('.modal').on('show.bs.modal', function () {
				$("html").addClass('ciuis-body-modal-open');
			});

			$('.modal').on('hidden.bs.modal', function () {
				$("html").removeClass('ciuis-body-modal-open');
			});
		}
	};
