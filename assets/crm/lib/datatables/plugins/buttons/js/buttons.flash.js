...
DataTable.ext.buttons.csvFlash = $.extend( {}, flashButton, {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.csv', '<img src="../../assets/img/csv.png">' );
	},
...
DataTable.ext.buttons.excelFlash = $.extend( {}, flashButton, {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.excel', '<img src="../../assets/img/excel.png">' );
	},
...
DataTable.ext.buttons.pdfFlash = $.extend( {}, flashButton, {
	...
	text: function ( dt ) {
		return dt.i18n( 'buttons.pdf', '<img src="../../assets/img/pdf.png">' );
	},
